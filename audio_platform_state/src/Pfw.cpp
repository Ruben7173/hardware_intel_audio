                                           ...
                                           const string &literalValue)
{
    ...
    AUDIOUTILITIES_ASSERT(criterionType != nullptr,
...
string Pfw<Trait>::getFormattedState(const string &typeName, uint32_t numeric) const
{
    ...
    if (criterionType == nullptr) {
        Log::Error() << __FUNCTION__ << ": " << typeName << " is not a member of " << mTag << " PFW";
        return "";
    }
                                   ...
                                   int &numeric) const
{
    ...
    if (criterion == nullptr) {
        Log::Error() << __FUNCTION__ << ": " << criterionName << " is not a member of " << mTag << " PFW";
        return false;
    }
